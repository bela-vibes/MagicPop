  ...
  },
{
 ...
 
  {
    ...
    description: {
      de: "Juckt Mich Nicht!\n\nFür die Kampagne „Don't bother me!“ von Dermapharm haben wir das Set Design für einen Werbefilm entwickelt und umgesetzt. Im Zentrum steht eine Familie, deren Umgang mit Mückenschutz langsam ins Absurde kippt. Wir haben sechs eigenständige Sets entworfen und gebaut, die zusammen eine geschlossene Welt bilden. Räume, die auf den ersten Blick vertraut wirken, sich aber leicht verschieben. Jede Szene folgt ihrer eigenen Logik, ohne beliebig zu werden.\n\nGedreht wurde innerhalb von zwei Tagen. Jedes Set wurde wie ein eigener Charakter behandelt, mit eigener Farbwelt und eigener Intensität. Kostüme und Requisiten greifen ineinander, ohne sich zu wiederholen, und verstärken die leicht überdrehte Realität.\n\nAgentur: I LIKE VISUALS",
      en: "Juckt Mich Nicht!\n\nFor Dermapharm’s “Juckt Mich Nicht!” campaign (eng. „Don't Bother Me!”), we developed and executed the set design for a commercial centered around a family whose approach to mosquito protection slowly drifts into the absurd. We designed and built six distinct sets that together form a coherent world. Spaces that feel familiar at first, yet slightly off. Each scene follows its own logic without becoming arbitrary.\n\nThe shoot was completed over two days. Each set was treated as a character, with its own color palette and level of intensity. Costumes and props interact without repeating themselves, reinforcing the slightly heightened reality.\n\nAgency: I LIKE VISUALS"
    },
    year: "2024",
