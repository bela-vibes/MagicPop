  ...
  },
{
 ...
 
  {
    ...
    description: {
      de: "Alles echt gebaut.\n\nFür das Musikvideo „Suitcase“ von Ameli in the Woods haben wir in Zusammenarbeit mit Amores Production die visuelle Umsetzung eng begleitet und mitgestaltet. Das Video bewegt sich zwischen späten 90ern und frühen 2000ern und greift die rohe, leicht unheimliche Ästhetik dieser Zeit auf. Entscheidend war dabei der analoge Ansatz. Effekte wie Zombie-Make-up, mechanische Herzen und projizierte Hintergründe wurden physisch umgesetzt und direkt am Set entwickelt.\n\nWir haben an vielen Ebenen der Umsetzung mitgearbeitet, von der Gestaltung der Szenen über Requisiten und Kostüm bis hin zur Arbeit am Licht. Statt einzelne Gewerke zu trennen, entstand so ein durchgehender visueller Zusammenhang. Das Licht und die Farbwelt greifen die Referenzen der Zeit auf und führen sie weiter. Leicht überzeichnet, aber bewusst gesetzt. So entsteht ein Look, der vertraut wirkt und gleichzeitig eine eigene Stimmung entwickelt.\n\nBand: Ameli in the Woods\nProduktion: Amores Production",
      en: "Everything built for real.\n\nFor the music video “Suitcase” by Ameli in the Woods, we collaborated closely with Amores Production and contributed across the visual execution. The video draws from the late 90s and early 2000s, capturing the raw and slightly eerie aesthetic of that era. A key aspect was the analog approach. Effects such as zombie makeup, mechanical hearts, and projected backgrounds were created physically and developed on set.\n\nWe were involved across multiple layers of the process, from shaping the scenes to props, costume, and lighting. Rather than separating disciplines, the work was approached as one continuous visual system. Lighting and color build on the references of the time while pushing them slightly further. The result is a look that feels familiar, yet carries its own atmosphere.\n\nBand: Ameli in the Woods\nProduction: Amores Production"
    },
    year: "2023",
