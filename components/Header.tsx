...
<>
<header
className={`fixed top-0 left-0 w-full z-[700] transition-all duration-500 ease-in-out px-6 lg:px-12 py-5 lg:py-6 flex justify-between items-center ${bgColor}`}
style={{
...
```
    <div className="flex items-center gap-4 lg:gap-10">
      {/* Desktop Nav — only visible from lg (1024px) upwards */}
  ...
  >
    ...
    {/* Copyright nur im Portrait sichtbar */}
